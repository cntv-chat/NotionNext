...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Peterlee', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个寻求心灵自由的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://456766.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '生活在别处, 科学上网，免费节点，软路由，openwrt', // 网站关键词 英文逗号隔开
